...
OPENROUTER_API_KEY = "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"
...
def generate_art():
    ...
    try:
        ...
        keyword_query = visual_keywords.replace(",", "").strip()
...
# --- AI ENDPOINTS (Updated with OpenRouter) ---
